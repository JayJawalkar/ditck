...
class _AdminScreenState extends State<AdminScreen>
  ...
  Future<void> _checkAdminCount() async {
    try {
      ...
      _showError('Failed to check Employee count: ${e.toString()}');
    }
  }
  ...
  Future<void> _shareCredentialsWhatsApp(
    ...
    final message = Uri.encodeComponent(
      "Hello,\nHere are your Employee credentials:\n"
      "Email: $email\n"
      "Password: $password\n"
      "Role: $role\n"
              ...
              child: Container(
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      Text(
                        docId == null ? 'Add Employee' : 'Edit Employee',
                        ...
                        children: [
                          ...
                          Expanded(
                            child: ElevatedButton(
                              ...
                              child: Text(
                                docId == null ? 'Add Employee' : 'Update',
                              ),
                              onPressed: () async {
                                // Reset errors
                                setModalState(() {
                                  ...
                                  if (docId == null) {
                                    ...
                                    if (snapshot.size >= 3) {
                                      ScaffoldMessenger.of(
                                        ...
                                        const SnackBar(
                                          content: Text(
                                            "Maximum of 3 Employees allowed.",
                                          ),
                                          backgroundColor: Colors.red,
                                        ),
                                      );
                ...
                children: [
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        Text(
                          "Admin: ${_truncate(ownerData!['name'])}",
                          style: const TextStyle(
                            color: Colors.white,
                            fontSize: 16,
